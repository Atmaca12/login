...
<body>
        ...
        <nav>
            <div class="container">
                <ul class="menu">
                    ...
                    <li class="menu_item"><a href="adminpanel/logout.php" class="menu_link">LOGOUT</a></li>
                    <li class="menu_item"><a href="adminpanel/index.php" class="menu_link">LOGİN</a></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-1">
                        <a href="#" class="subheader_logo"><img src="img/logo/logo.png" alt="logo"></a>
    ...
    <section class="promo">
          <form action="adminpanel/other.php" method="POST" >
        <div class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <h1 class="promo_header">КОМПАНИЯ UBER PARTNERS!</h1>
                    <h1 class="promo_subheader">ПРИГЛАШАЕМ ВОДИТЕЛЕЙ! НА СВОЕМ АВТО!</h1>
    ...
    <section class="advantages">
        ...
        <div class="container">
            <div class="header_section">
                <div class="advatages_head button_style">преимущества</div>
                <h2 class="causes header_style">8 причин начать работать с нами</h2>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon1.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Никаких наличных, оплата происходит
                                автоматически</h4>
                            <div class="advantages_text">Стоимость поездки оплачивается пассажиром с привязанной
                                ...
                                и
                                для
                                водителя, Вам не нужно искать мелкие деньги для размена.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon2.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Высокий доход с гарантированными
                                выплатами</h4>
                            <div class="advantages_text">Мы выплачиваем заработную плату на личную банковскую карту
                                ...
                                бухгалтерские
                                услуги и ведение банковского счета.</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon3.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Комфортное, прозрачное и простое
                                подключение</h4>
                            <div class="advantages_text">Мы подключаем дистанционно и бесплатно, Вам нет необходимости
                                ...
                                подключения, через 1-2 дня Вы можете начинать работать!</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon4.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Круглосуточная поддержка</h4>
                ...
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon5.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Комиссия 8% + БОНУСЫ</h4>
                ...
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon6.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Работа в удобное время, никаких
                                графиков</h4>
                            <div class="advantages_text">Вы просто нажимаете кнопку выйти на линию для начала работы,
                                ...
                                вечером, в
                                выходные или праздничные дни! </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon7.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Всегда большое количество заказов</h4>
                            <div class="advantages_text">Приложение показывает, где на данный момент больше всего
                                заказов и
                                где
                                действуют повышенные тарифы. У Вас не будет простоя и холостых пробегов. Наши пассажиры
                                всегда
                ...
                <div class="col-md-6">
                    <div class="advantages_box">
                        <div class="blue_round">
                            <img src="icons/icon8.png" alt="" class="icons">
                        </div>
                        <div class="full_text-container">
                            <h4 class="head_text_advantages">Без шашечек и наклеек</h4>
    ...
    <section class="mobile">
        <div class="container">
            <div class="button_style">Возможности</div>
            <div class="header_style">мобильное приложение убер</div>
    ...
    <section class="choice">
        <div class="container">
            <div class="black"></div>
            <div class="button_style label_white">возможности</div>
            <h2 class="header_style title_white">Выбор - отличная штука!</h2>
            <div class="subtitle subtitle_white">Закажите автомобиль, который подходит вам по стилю и бюджету</div>

            <img src="img/bg/carimg.png" alt="uber car" class="choice_img">
    ...
    <section class="require">
        <div class="container">
            <div class="button_style">Возможности</div>
            <div class="header_style">условия и требования</div>
            <div class="row">
                <div class="col-md-6">
    ...
    <section class="city">
        <div class="container">
            <div class="button_style label_white">города</div>
            <h2 class="header_style title_white">По всему миру</h2>
            <div class="subtitle subtitle_white">Мы в вашем городе и по всему миру</div>
            <div class="city_subtext">
                <a href="#" class="city_subtext_link">посмотреть все города</a>
            </div>
        </div>
    </section>
    <footer>
        ...
        <div class="footer_wrapper">
            ...
            <div>
                <div class="footer_mobile">
                    <a href="#">
                        <img src="icons/store/applestore.png" alt="App Store">
                    </a>
                    <a href="#">
                        <img src="icons/store/playstore.png" alt="Google play">
                    </a>
                    <a href="#">
                        <img src="icons/store/windowsstore.png" alt="Windows store">
                    </a>
                </div>
            </div>
        </div>
